...
\cleardoublepage
\ResetCounters{4}
\CustomChapter{4}{Quasinormal Modes and the Ringdown Test of the Kerr Hypothesis}
\ChapterQuote{If I have seen further, it is by standing on the shoulders of giants.}{Isaac Newton}
\phantomsection
\addcontentsline{toc}{chapter}{Chapter 4: Quasinormal Modes and the Ringdown Test of the Kerr Hypothesis}
\markboth{Quasinormal Modes and the Ringdown Test of the Kerr Hypothesis}{}
\ChapterHeader

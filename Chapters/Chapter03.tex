...
\cleardoublepage
\ResetCounters{3}
\CustomChapter{3}{Numerical Study of Photon Trajectories and Black Hole Shadows}
\ChapterQuote{The energy of the universe is constant; the entropy of the universe tends to a maximum.}{Rudolf Clausius}
\phantomsection
\addcontentsline{toc}{chapter}{Chapter 3: Numerical Study of Photon Trajectories and Black Hole Shadows}
\markboth{Numerical Study of Photon Trajectories and Black Hole Shadows}{}
\ChapterHeader

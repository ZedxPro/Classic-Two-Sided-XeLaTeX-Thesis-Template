...
\cleardoublepage
\ResetCounters{2}
\CustomChapter{2}{Geodesic Structure of Rotating Spacetimes: The Kerr Metric}
\ChapterQuote{Heat, like a fluid, tends to pass from a body which is hotter to one which is colder.}{Joseph Fourier}
\phantomsection
\addcontentsline{toc}{chapter}{Chapter 2: Geodesic Structure of Rotating Spacetimes: The Kerr Metric}
\markboth{Geodesic Structure of Rotating Spacetimes: The Kerr Metric}{}
\ChapterHeader

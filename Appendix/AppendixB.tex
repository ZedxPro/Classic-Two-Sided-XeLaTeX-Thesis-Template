...
% ==========================
\cleardoublepage
\CustomAppendixIntro{B}{Complementary Analytical Derivations}

\setcounter{chapter}{2} % internal counters only (equations, figures...)
\setcounter{figure}{0}
\setcounter{table}{0}
\addcontentsline{toc}{chapter}{Appendix B -- Complementary Analytical Derivations}

\markboth{Complementary Analytical Derivations}{}
\label{ann:B}

	...
	% ==========================
	\cleardoublepage
	\CustomAppendixIntro{A}{Numerical Validation}
	
	\setcounter{chapter}{1} % internal counters only (equations, figures...)
	\setcounter{figure}{0}
	\setcounter{table}{0}
	\addcontentsline{toc}{chapter}{Appendix A -- Numerical Validation}
	
	\markboth{Numerical Validation}{}
	\label{ann:A}
